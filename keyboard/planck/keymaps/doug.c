...
[_QWERTY] = {
  ...
  {NAVIG,   KC_LALT, KC_TAB,  KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_ENT,  KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_NAVIG] = {
  ...
  {KC_TAB,  _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______},
